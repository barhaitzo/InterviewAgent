...
class EmailSender:
    ...
    @staticmethod
    def build_html(anecdote: str, key_takeaway: str, topic: str, model: str = config.GEN_MODEL) -> str:
...
<body style="font-family: Georgia, serif; max-width: 620px; margin: 40px auto; color: #1a1a1a; line-height: 1.75;">
  ...
  <p style="margin-top: 12px; font-style: italic; color: #333;">{key_takeaway}</p>

  <p style="font-size: 11px; color: #bbb; margin-top: 48px; border-top: 1px solid #f0f0f0; padding-top: 16px;">
    Generated by your InterviewAgent &middot; Ollama + {model}
  </p>
</body>
</html>"""
